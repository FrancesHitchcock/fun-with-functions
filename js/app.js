...
function sum(a, b) {
  //eslint-disable-line
  const firstEl = a + b;
  const secondEl = "The sum of " + a + " and " + b + " is " + firstEl + ".";
...
function multiply(a, b) {
  //eslint-disable-line
  const firstEl = a * b;
  const secondEl = "The product of " + a + " and " + b + " is " + firstEl + ".";
...
function multiplyArray(multArr) {
  //eslint-disable-line
  const tempProduct = multiply(multArr[0], multArr[1])[0];
  const firstEl = multiply(tempProduct, multArr[2])[0];
